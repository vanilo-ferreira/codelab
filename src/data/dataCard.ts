import { Publications } from "../interfaces/IPublications";

export const dataCard: Array<Publications> = [
  {
    id: 1,
    title: "O que é linguagem de programação? Conheça as principais",
    description: `Uma das mais populares vertentes da tecnologia da informação, a
